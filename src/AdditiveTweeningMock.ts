...
export class AdditiveTweeningMock {
    ...
    install(additiveTweening: typeof AdditiveTweening): void {
        this.stubMethodNames.forEach((method) => {
            this.originalMethods[method] = (additiveTweening.prototype as any)[
                method
            ];
            (additiveTweening.prototype as any)[method] = (this as any)[
                method
            ].bind(this);
        });
        this.reset();
    ...
    uninstall(additiveTweening: typeof AdditiveTweening): void {
        this.stubMethodNames.forEach((method) => {
            (additiveTweening.prototype as any)[method] = this.originalMethods[
                method
            ];
        });
        this.reset();
